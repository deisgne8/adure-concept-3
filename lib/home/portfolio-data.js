...
const study = (city, source, position, form) => ({
  ...
  name: source.caption,
  city,
  neighbourhood: "Location unconfirmed",
  category: "Category unconfirmed",
  latitude: null,
  longitude: null,
  modelNodeId: `${city}-${source.id}`,
  scenePosition: position,
  form,
  image: `assets/${source.image}.webp`,
  alt: source.alt,
  shortDescription: source.detail,
  detailUrl: null,
  dataStatus: "demo",
...
export const propertiesForCity = (id) =>
  demoProperties.filter((property) => property.city === id);
