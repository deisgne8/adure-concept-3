...
export function matchProperties(filters) {
  return properties.filter(
    (p) =>
      ...
      (!filters.bedrooms || filters.bedrooms === "Any bedrooms" ||
        (filters.bedrooms === "Studio" ? p.beds === 0 : filters.bedrooms === "1–2 bedrooms" ? p.beds >= 1 && p.beds <= 2 : p.beds >= 3)) &&
      (!filters.price || filters.price === "Any price" ||
        (filters.price === "Under AED 100K" ? p.price < 100000 : filters.price === "AED 100K–200K" ? p.price >= 100000 && p.price <= 200000 : p.price > 200000)) &&
